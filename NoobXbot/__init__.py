...
import asyncio
from NoobXbot.config import API_ID, API_HASH, BOT_TOKEN, MONGO_DB_URI, SUDO_USERS
...
from NoobXbot.config import API_ID, API_HASH, BOT_TOKEN, MONGO_DB_URI, SUDO_USERS, LOG_GROUP_ID, ASS_ACC, call_py, OWNER_ID
from pyrogram import Client
