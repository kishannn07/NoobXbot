...
from NoobXbot.NoobXUtilities.helpers.inline import others_markup, play_markup
...
async def getspy(_,CallbackQuery):  
    ...
    universal = InlineKeyboardButton(text="ᴅᴇʟᴇᴛᴇ •", callback_data=f'close2')
    if j == 0:
        return await CallbackQuery.message.reply_text("Video Format Not Found..")
    elif j == 1:
        key = InlineKeyboardMarkup(
            [
                ...
                [
                    ...
                    InlineKeyboardButton(text="ᴅᴇʟᴇᴛᴇ", callback_data=f'close2')
                ]    
            ]
        )
    elif j == 2:
